...
using Bitcoin.BIP39;
using Wordlists = Bitcoin.BIP39.Wordlists;

namespace Bitcoin.BIP39
{
    /// <summary>
    /// A .NET implementation of the Bitcoin Improvement Proposal - 39 (OriginalBIP39)
    /// OriginalBIP39 specification used as reference located here: https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki
    /// Made by thashiznets@yahoo.com.au
    /// v1.0.1.1
    /// I ♥ Bitcoin :)
    /// Bitcoin:1ETQjMkR1NNh4jwLuN5LxY7bMsHC9PUPSV
    /// </summary>
    public class OriginalBIP39
    {
        ...
        public const string cSaltHeader = "mnemonic"; //this is the first part of the salt as described in the OriginalBIP39 spec
        ...
        /// <summary>
        /// Constructor to build a OriginalBIP39 object from scratch given an entropy size and an optional passphrase. Language is optional and will default to English
        /// </summary>
        ...
        public OriginalBIP39(int entropySize = cMinimumEntropyBits, string passphrase = cEmptyString, Language language = Language.English)
        {
        ...
        /// <summary>
        /// Constructor to build a OriginalBIP39 object using supplied entropy bytes eighter from a previously created OriginalBIP39 object or another method of entropy generation.
        /// </summary>
        ...
        /// <param name="language">The optional language. If no language is provided English will be used</param>
        public OriginalBIP39(byte[] entropyBytes, string passphrase = cEmptyString, Language language = Language.English)
        {
        ...
        /// <summary>
        /// Constructor to build a OriginalBIP39 object using a supplied Mnemonic sentence and passphrase. If you are not worried about saving the entropy bytes, or using custom words not in a wordlist, you should consider the static method to do this instead.
        /// </summary>
        ...
        public OriginalBIP39(string mnemonicSentence, string passphrase = cEmptyString, Language language = Language.Unknown)
        {
        ...
        /// <summary>
        /// An asynchronous static method to create a new OriginalBIP39 from random entropy. The random entropy creation is CPU intensive so is run in its own Task and we await as per async pattern.
        /// </summary>
        /// <param name="entropySize">The size in bits of the entropy to be created</param>
        /// <param name="passphrase">The optional passphrase. Please ensure NFKD Normalized, Empty string will be used if not provided as per spec</param>
        /// <param name="language">The optional language. If no language is provided English will be used</param>
        /// <returns>A OriginalBIP39 object</returns>
        public static async Task<OriginalBIP39> GetOriginalBIP39Async(int entropySize = cMinimumEntropyBits, string passphrase = cEmptyString, Language language = Language.English)
        {
            byte[] entropyBytes = await Utilities.GetRandomBytesAsync(entropySize / cBitsInByte);
            return new OriginalBIP39(entropyBytes, passphrase, language);
        }
        ...
        /// <summary>
        /// Common initialisation code utilised by all the constructors. It gets all the bits and does a checksum etc. This is the main code to create a OriginalBIP39 object.
        /// </summary>
